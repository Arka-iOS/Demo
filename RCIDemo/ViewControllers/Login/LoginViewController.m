...
#import "RCIOffersViewController.h"
#import "RCISearchViewController.h"
#import "RCIProfileViewController.h"
#import "RCIVacationsViewController.h"
...
- (IBAction)signInBtnClckd:(id)sender {
    ...
    home.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Home" image:[UIImage imageNamed:@"home-1"] tag:1];
   
    RCIOffersViewController *offers = [[RCIOffersViewController alloc] initWithNibName:@"RCIOffersViewController" bundle:nil];
    offers.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Offers" image:[UIImage imageNamed:@"offers-1"] tag:2];

    RCISearchViewController *search = [[RCISearchViewController alloc] initWithNibName:@"RCISearchViewController" bundle:nil];
    search.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Search" image:[UIImage imageNamed:@"search_tab"] tag:2];

    UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:search];

    RCITimeLineViewController *vacation = [[RCITimeLineViewController alloc] initWithNibName:@"RCITimeLineViewController" bundle:nil];
    vacation.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Vacation" image:[UIImage imageNamed:@"vacations"] tag:4];

    RCIProfileViewController *profile = [[RCIProfileViewController alloc] initWithNibName:@"RCIProfileViewController" bundle:nil];
    profile.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Profile" image:[UIImage imageNamed:@"profile-1"] tag:5];

    
    self.tabController.viewControllers = @[home, offers, navController, vacation, profile];
    [self.tabController.tabBar setTintColor:[UIColor colorWithRed:0 green:111/255.0 blue:138/255.0 alpha:1.0]];
...
-(void)setupNavgationBarStyle {
    ...
    [[UITabBarItem appearance] setTitleTextAttributes:@{ NSForegroundColorAttributeName : [UIColor colorWithRed:0 green:111/255.0 blue:138/255.0 alpha:1.0]}
                                             forState:UIControlStateSelected];
    [[UINavigationBar appearance] setBackgroundImage:[UIImage imageNamed:@"bg-top"]
