...
-(void)expandTableViewForCell:(UITableViewCell *)cell {
    ...
    [self.resortOverViewTableView reloadData];
...
-(void)checkAvailability {
    ...
    RCICheckAvailabilityViewController *checkAvailability = [[RCICheckAvailabilityViewController alloc]init];
    [self.navigationController pushViewController:checkAvailability animated:YES];
